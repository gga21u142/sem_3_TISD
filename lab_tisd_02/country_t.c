...
{
	printf("%20s %16d %20s %20s %3d %10s ", country->country_name, country->population, country->capital_name, country->continent_name, country->vaccine_need, country->main_tourism);
	fflush(stdout);
